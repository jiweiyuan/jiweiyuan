...
- [RunBrowser](https://github.com/runbrowser/runbrowser) ![GitHub stars](https://img.shields.io/github/stars/runbrowser/runbrowser?style=flat-square) — CDP browser automation on your real Chrome — logins, cookies, extensions included.
- [Feedar](https://github.com/jiweiyuan/feedar) ![GitHub stars](https://img.shields.io/github/stars/jiweiyuan/feedar?style=flat-square) — RSS reader for AI agents.
- [TTS CLI](https://github.com/jiweiyuan/ttscli) ![GitHub stars](https://img.shields.io/github/stars/jiweiyuan/ttscli?style=flat-square) — Text-to-speech CLI with voice cloning. MLX + PyTorch.
